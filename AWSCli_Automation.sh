...
main() {
    ...
    KEY_NAME="sumit_cloud_pem"
    SUBNET_ID="subnet-02c70686ab298583d"
    SECURITY_GROUP_IDS="sg-0cd2b900a8a5aa848"  # Add your security group IDs separated by space
    INSTANCE_NAME="Sumit_CLI_Instance"
